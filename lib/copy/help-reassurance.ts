...
/** Payment: card via MangoPay, automatic confirmation */
export const PAYMENT_FAQ_ITEMS: FAQItem[] = [
  {
    question: "איך משלמים?",
    answer:
      "לוחצים על כפתור התשלום, משלמים בכרטיס אשראי בעמוד מאובטח, וההזמנה מאושרת אוטומטית.",
  },
  {
    question: "מה קורה אחרי התשלום?",
    answer:
      "ההזמנה מאושרת אוטומטית מיד לאחר תשלום מוצלח. תראו הוראות איסוף ותוכלו לתאם עם המלווה.",
  },
  {
...
export const HOME_FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "מחפשים ציוד, בוחרים תאריכים ומשלמים בכרטיס אשראי. אחרי אישור תקבלו הוראות איסוף. באיסוף מצלמים את מצב הפריט, ובהחזרה אותו דבר — הפיקדון מוחזר בהתאם למצב.",
  },
  {
    question: "מתי מחזירים את הפיקדון?",
    answer:
