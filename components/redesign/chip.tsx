export interface RedesignChipProps {
  label: string;
  selected?: boolean;
  onClick?: () => void;
  tone?: "default" | "hero";
...
const TONE_CLASSES = {
  default: {
    ...
    unselected: "border-black/15 bg-white text-black hover:border-black/30",
  },
  hero: {
    selected: "border-[#1A8C6A] bg-[#1A8C6A] text-white",
    unselected: "border-white/20 bg-white/8 text-white/80 hover:border-white/30",
  },
} as const;

export function RedesignChip({
  label,
  selected = false,
  onClick,
  tone = "default",
